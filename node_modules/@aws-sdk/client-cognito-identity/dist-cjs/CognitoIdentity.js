...
class CognitoIdentity extends CognitoIdentityClient_1.CognitoIdentityClient {
  createIdentityPool(args, optionsOrCb, cb) {
    const command = new CreateIdentityPoolCommand_1.CreateIdentityPoolCommand(
      args
    );
  ...
  deleteIdentityPool(args, optionsOrCb, cb) {
    const command = new DeleteIdentityPoolCommand_1.DeleteIdentityPoolCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  describeIdentityPool(args, optionsOrCb, cb) {
    const command = new DescribeIdentityPoolCommand_1.DescribeIdentityPoolCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  getCredentialsForIdentity(args, optionsOrCb, cb) {
    const command = new GetCredentialsForIdentityCommand_1.GetCredentialsForIdentityCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  getIdentityPoolRoles(args, optionsOrCb, cb) {
    const command = new GetIdentityPoolRolesCommand_1.GetIdentityPoolRolesCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  getOpenIdTokenForDeveloperIdentity(args, optionsOrCb, cb) {
    const command = new GetOpenIdTokenForDeveloperIdentityCommand_1.GetOpenIdTokenForDeveloperIdentityCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  getPrincipalTagAttributeMap(args, optionsOrCb, cb) {
    const command = new GetPrincipalTagAttributeMapCommand_1.GetPrincipalTagAttributeMapCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  listIdentityPools(args, optionsOrCb, cb) {
    const command = new ListIdentityPoolsCommand_1.ListIdentityPoolsCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  listTagsForResource(args, optionsOrCb, cb) {
    const command = new ListTagsForResourceCommand_1.ListTagsForResourceCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  lookupDeveloperIdentity(args, optionsOrCb, cb) {
    const command = new LookupDeveloperIdentityCommand_1.LookupDeveloperIdentityCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  mergeDeveloperIdentities(args, optionsOrCb, cb) {
    const command = new MergeDeveloperIdentitiesCommand_1.MergeDeveloperIdentitiesCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  setIdentityPoolRoles(args, optionsOrCb, cb) {
    const command = new SetIdentityPoolRolesCommand_1.SetIdentityPoolRolesCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  setPrincipalTagAttributeMap(args, optionsOrCb, cb) {
    const command = new SetPrincipalTagAttributeMapCommand_1.SetPrincipalTagAttributeMapCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  unlinkDeveloperIdentity(args, optionsOrCb, cb) {
    const command = new UnlinkDeveloperIdentityCommand_1.UnlinkDeveloperIdentityCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  updateIdentityPool(args, optionsOrCb, cb) {
    const command = new UpdateIdentityPoolCommand_1.UpdateIdentityPoolCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
